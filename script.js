...
async function processCity(city, searchType, timeSelection, filters) {
    ...
    try {
        ...
        const leafletMarker = L.marker([city.coord.Lat, city.coord.Lon], { icon: weatherIcon }).bindPopup(popupContent);
...
// Função para configurar os seletores de data
function initializeDatePickers() {
    ...
    // Configura os limites para todos os seletores
    ...
    // Garante que a data de fim não é anterior à data de início
...
document.addEventListener('DOMContentLoaded', () => {
    updateTimeModeUI();
    initializeDatePickers(); // Chama a nova função de inicialização
    ...
    // Adiciona listeners para os novos seletores de data
    ...
    return `
      <div class="weather-popup">
        ...
        <div class="popup-data-content">
          ...
          <p>🌤️ <strong>Condition:</strong> ${entry.weather[0].description}</p>

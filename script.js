...
async function applyFilters() {
    ...
    if (searchType === 'exact_forecast' || searchType === 'range_forecast') {
        ...
        if (searchType === 'exact_forecast') {
            ...
            timeSelection.start = new Date(Date.UTC(year, jsMonth, day, hour));
            timeSelection.end = new Date(Date.UTC(year, jsMonth, day, hour));
        } else {
            ...
            timeSelection.start = new Date(Date.UTC(year, jsMonth, day, startHour));
            timeSelection.end = new Date(Date.UTC(year, jsMonth, day, endHour));
        }
    }

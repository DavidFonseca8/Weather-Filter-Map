    ...
    .then(data => {
      ...
      async function fetchCityWeather(city) {
        ...
        try {
          ...
          map.addLayer(markerCluster); // garante que o cluster está ativo
          markerCluster.addLayer(leafletMarker); // adiciona o marcador imediatamente
